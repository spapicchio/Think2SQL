...
from think2sql.configs import CommonScriptArguments
from think2sql.logger import get_logger

logger = get_logger(__name__)


def get_dataset(args: CommonScriptArguments) -> DatasetDict:
    """Load a dataset or a mixture of datasets based on the configuration.

    Args:
        args (CommonScriptArguments): Script arguments containing dataset configuration.
